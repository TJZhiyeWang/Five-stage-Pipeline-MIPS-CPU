...
HD_PWD='E:/Vivado-projects/pipeline_cpu/pipeline_cpu.runs/ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ROM.tcl
