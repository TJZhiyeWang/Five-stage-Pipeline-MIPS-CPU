...
HD_PWD='E:/Vivado-projects/pipeline_cpu/pipeline_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pipeline_cpu.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Pipeline_cpu.tcl
